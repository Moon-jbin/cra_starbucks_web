            ...
            <div className="slide-container">
                <div className="slide-view">
                    <ul className="slide-wrap clearfix">
                        <li className="slide slide3"><img src="./images/slide_03.jpg" alt="img"/><span><a href="#" className="view-btn" title="자세히 보기">자세히 보기</a></span></li>
                        <li className="slide slide1 addCurrent"><img src="./images/slide_01.jpg" alt="img"/><span><a href="#" className="view-btn" title="자세히 보기">자세히 보기</a></span></li>
                        <li className="slide slide2"><img src="./images/slide_02.jpg" alt="img"/><span><a href="#" className="view-btn" title="자세히 보기">자세히 보기</a></span></li>
                        <li className="slide slide3"><img src="./images/slide_03.jpg" alt="img"/><span><a href="#" className="view-btn" title="자세히 보기">자세히 보기</a></span></li>
                        <li className="slide slide1 addCurrent"><img src="./images/slide_01.jpg" alt="img"/><span><a href="#" className="view-btn" title="자세히 보기">자세히 보기</a></span></li>
                    </ul>
                </div>
                ...
                <div className="page-btn-box">
                    <span><a href="#" className="play-btn on" title="Play & Stop"><img src="./images/main_prom_stop.png" alt="img"/></a></span>
                    <span><a href="#" className="page-btn" title="page1"><img src="./images/main_prom_on.png" alt="img"/></a></span>
                    <span><a href="#" className="page-btn" title="page2"><img src="./images/main_prom_off.png" alt="img"/></a></span>
                    <span><a href="#" className="page-btn" title="page3"><img src="./images/main_prom_off.png" alt="img"/></a></span>
                </div>
