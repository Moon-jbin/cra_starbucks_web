...
<header id="header">
    <div className="container clearfix">
      ...
      <div className="nav-box">
        ...
        <div id="mobile">
            <ul>
                <li><a href="#" className="login-btn"><img src="./images/icon_user_m.png" alt="이미지"/></a></li>
                <li><a href="#" className="maps-btn"><img src="./images/icon_spot_m.png" alt="이미지"/></a></li>
                <li><a href="#" className="berger-btn"><img src="./images/btn_berger_m.png" alt="이미지"/></a></li>
            </ul>
        </div>
